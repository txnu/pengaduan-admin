...
import ReportProsessed from "../reportProssed";

const ReportProcessedController = () => {
  ...
  return <ReportProsessed reports={reports} />;
};

export default ReportProcessedController;
